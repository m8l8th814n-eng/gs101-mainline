...
#define CLKS_NR_CSIS	(CLK_GOUT_CSIS_QE_CSIS_DMA3_PCLK + 1)
...
/*
 * Generated from the vendor cal-if tables (cmucal-sfr.c / cmucal-node.c,
 * kernel-raviole-15260412 gs101) with ~/pmbootstrap/exynosclocks/exynos-clk-gen
 * (gen990.py --calif <gs101 cal-if> --emit CMU_CSIS --qch), then adapted to
 * the gs101 conventions used by the other CMU blocks in this file.
 * Register offsets verified against cal-if: 73/73 control registers modelled,
 * 51 Q-channel registers saved for suspend. CMU_CSIS sits in the pd_csis power
 * domain (on at boot; mainline does not model gs101 power domains yet).
 */

/* Register Offset definitions for CMU_CSIS (0x1a400000) */
#define CSIS_CMU_CSIS_CONTROLLER_OPTION												0x0800
#define PLL_CON0_MUX_CLKCMU_CSIS_BUS_USER                          0x0600
#define CLK_CON_DIV_DIV_CLK_CSIS_BUSP                              0x1800
#define CLK_CON_GAT_CLK_BLK_CSIS_UID_CSIS_CMU_CSIS_IPCLKPORT_PCLK  0x2000
#define CLK_CON_GAT_GOUT_BLK_CSIS_UID_AD_APB_CSIS0_IPCLKPORT_PCLKM 0x2004
#define CLK_CON_GAT_GOUT_BLK_CSIS_UID_CSISX8_IPCLKPORT_ACLK_C2_CSIS 0x2008
#define CLK_CON_GAT_GOUT_BLK_CSIS_UID_CSISX8_IPCLKPORT_ACLK_CSIS_DMA 0x200c
#define CLK_CON_GAT_GOUT_BLK_CSIS_UID_CSISX8_IPCLKPORT_ACLK_EBUF   0x2010
#define CLK_CON_GAT_GOUT_BLK_CSIS_UID_D_TZPC_CSIS_IPCLKPORT_PCLK   0x2014
#define CLK_CON_GAT_GOUT_BLK_CSIS_UID_GPC_CSIS_IPCLKPORT_PCLK      0x2018
#define CLK_CON_GAT_GOUT_BLK_CSIS_UID_LHM_AST_OTF0_PDPCSIS_IPCLKPORT_I_CLK 0x201c
#define CLK_CON_GAT_GOUT_BLK_CSIS_UID_LHM_AST_OTF1_PDPCSIS_IPCLKPORT_I_CLK 0x2020
#define CLK_CON_GAT_GOUT_BLK_CSIS_UID_LHM_AST_OTF2_PDPCSIS_IPCLKPORT_I_CLK 0x2024
#define CLK_CON_GAT_GOUT_BLK_CSIS_UID_LHM_AST_SOTF0_IPPCSIS_IPCLKPORT_I_CLK 0x2028
#define CLK_CON_GAT_GOUT_BLK_CSIS_UID_LHM_AST_SOTF1_IPPCSIS_IPCLKPORT_I_CLK 0x202c
#define CLK_CON_GAT_GOUT_BLK_CSIS_UID_LHM_AST_SOTF2_IPPCSIS_IPCLKPORT_I_CLK 0x2030
#define CLK_CON_GAT_GOUT_BLK_CSIS_UID_LHM_AST_VO_MCSCCSIS_IPCLKPORT_I_CLK 0x2034
#define CLK_CON_GAT_GOUT_BLK_CSIS_UID_LHM_AST_ZOTF0_IPPCSIS_IPCLKPORT_I_CLK 0x2038
#define CLK_CON_GAT_GOUT_BLK_CSIS_UID_LHM_AST_ZOTF1_IPPCSIS_IPCLKPORT_I_CLK 0x203c
#define CLK_CON_GAT_GOUT_BLK_CSIS_UID_LHM_AST_ZOTF2_IPPCSIS_IPCLKPORT_I_CLK 0x2040
#define CLK_CON_GAT_GOUT_BLK_CSIS_UID_LHM_AXI_D_PDPCSIS_IPCLKPORT_I_CLK 0x2044
#define CLK_CON_GAT_GOUT_BLK_CSIS_UID_LHM_AXI_P_CSIS_IPCLKPORT_I_CLK 0x2048
#define CLK_CON_GAT_GOUT_BLK_CSIS_UID_LHS_AST_OTF0_CSISPDP_IPCLKPORT_I_CLK 0x204c
#define CLK_CON_GAT_GOUT_BLK_CSIS_UID_LHS_AST_OTF1_CSISPDP_IPCLKPORT_I_CLK 0x2050
#define CLK_CON_GAT_GOUT_BLK_CSIS_UID_LHS_AST_OTF2_CSISPDP_IPCLKPORT_I_CLK 0x2054
#define CLK_CON_GAT_GOUT_BLK_CSIS_UID_LHS_AST_VO_CSISPDP_IPCLKPORT_I_CLK 0x2058
#define CLK_CON_GAT_GOUT_BLK_CSIS_UID_LHS_AXI_D0_CSIS_IPCLKPORT_I_CLK 0x205c
#define CLK_CON_GAT_GOUT_BLK_CSIS_UID_LHS_AXI_D1_CSIS_IPCLKPORT_I_CLK 0x2060
#define CLK_CON_GAT_GOUT_BLK_CSIS_UID_MIPI_PHY_LINK_WRAP_IPCLKPORT_ACLK_CSIS0 0x2064
#define CLK_CON_GAT_GOUT_BLK_CSIS_UID_MIPI_PHY_LINK_WRAP_IPCLKPORT_ACLK_CSIS1 0x2068
#define CLK_CON_GAT_GOUT_BLK_CSIS_UID_MIPI_PHY_LINK_WRAP_IPCLKPORT_ACLK_CSIS2 0x206c
#define CLK_CON_GAT_GOUT_BLK_CSIS_UID_MIPI_PHY_LINK_WRAP_IPCLKPORT_ACLK_CSIS3 0x2070
#define CLK_CON_GAT_GOUT_BLK_CSIS_UID_MIPI_PHY_LINK_WRAP_IPCLKPORT_ACLK_CSIS4 0x2074
#define CLK_CON_GAT_GOUT_BLK_CSIS_UID_MIPI_PHY_LINK_WRAP_IPCLKPORT_ACLK_CSIS5 0x2078
#define CLK_CON_GAT_GOUT_BLK_CSIS_UID_MIPI_PHY_LINK_WRAP_IPCLKPORT_ACLK_CSIS6 0x207c
#define CLK_CON_GAT_GOUT_BLK_CSIS_UID_MIPI_PHY_LINK_WRAP_IPCLKPORT_ACLK_CSIS7 0x2080
#define CLK_CON_GAT_GOUT_BLK_CSIS_UID_PPMU_D0_IPCLKPORT_ACLK       0x2084
#define CLK_CON_GAT_GOUT_BLK_CSIS_UID_PPMU_D0_IPCLKPORT_PCLK       0x2088
#define CLK_CON_GAT_GOUT_BLK_CSIS_UID_PPMU_D1_IPCLKPORT_ACLK       0x208c
#define CLK_CON_GAT_GOUT_BLK_CSIS_UID_PPMU_D1_IPCLKPORT_PCLK       0x2090
#define CLK_CON_GAT_GOUT_BLK_CSIS_UID_QE_CSIS_DMA0_IPCLKPORT_ACLK  0x2094
#define CLK_CON_GAT_GOUT_BLK_CSIS_UID_QE_CSIS_DMA0_IPCLKPORT_PCLK  0x2098
#define CLK_CON_GAT_GOUT_BLK_CSIS_UID_QE_CSIS_DMA1_IPCLKPORT_ACLK  0x209c
#define CLK_CON_GAT_GOUT_BLK_CSIS_UID_QE_CSIS_DMA1_IPCLKPORT_PCLK  0x20a0
#define CLK_CON_GAT_GOUT_BLK_CSIS_UID_QE_CSIS_DMA2_IPCLKPORT_ACLK  0x20a4
#define CLK_CON_GAT_GOUT_BLK_CSIS_UID_QE_CSIS_DMA2_IPCLKPORT_PCLK  0x20a8
#define CLK_CON_GAT_GOUT_BLK_CSIS_UID_QE_CSIS_DMA3_IPCLKPORT_ACLK  0x20ac
#define CLK_CON_GAT_GOUT_BLK_CSIS_UID_QE_CSIS_DMA3_IPCLKPORT_PCLK  0x20b0
#define CLK_CON_GAT_GOUT_BLK_CSIS_UID_QE_STRP0_IPCLKPORT_ACLK      0x20b4
#define CLK_CON_GAT_GOUT_BLK_CSIS_UID_QE_STRP0_IPCLKPORT_PCLK      0x20b8
#define CLK_CON_GAT_GOUT_BLK_CSIS_UID_QE_STRP1_IPCLKPORT_ACLK      0x20bc
#define CLK_CON_GAT_GOUT_BLK_CSIS_UID_QE_STRP1_IPCLKPORT_PCLK      0x20c0
#define CLK_CON_GAT_GOUT_BLK_CSIS_UID_QE_STRP2_IPCLKPORT_ACLK      0x20c4
#define CLK_CON_GAT_GOUT_BLK_CSIS_UID_QE_STRP2_IPCLKPORT_PCLK      0x20c8
#define CLK_CON_GAT_GOUT_BLK_CSIS_UID_QE_ZSL0_IPCLKPORT_ACLK       0x20cc
#define CLK_CON_GAT_GOUT_BLK_CSIS_UID_QE_ZSL0_IPCLKPORT_PCLK       0x20d0
#define CLK_CON_GAT_GOUT_BLK_CSIS_UID_QE_ZSL1_IPCLKPORT_ACLK       0x20d4
#define CLK_CON_GAT_GOUT_BLK_CSIS_UID_QE_ZSL1_IPCLKPORT_PCLK       0x20d8
#define CLK_CON_GAT_GOUT_BLK_CSIS_UID_QE_ZSL2_IPCLKPORT_ACLK       0x20dc
#define CLK_CON_GAT_GOUT_BLK_CSIS_UID_QE_ZSL2_IPCLKPORT_PCLK       0x20e0
#define CLK_CON_GAT_GOUT_BLK_CSIS_UID_RSTNSYNC_CLK_CSIS_BUSD_IPCLKPORT_CLK 0x20e4
#define CLK_CON_GAT_GOUT_BLK_CSIS_UID_RSTNSYNC_CLK_CSIS_BUSP_IPCLKPORT_CLK 0x20e8
#define CLK_CON_GAT_GOUT_BLK_CSIS_UID_SSMT_D0_IPCLKPORT_ACLK       0x20ec
#define CLK_CON_GAT_GOUT_BLK_CSIS_UID_SSMT_D0_IPCLKPORT_PCLK       0x20f0
#define CLK_CON_GAT_GOUT_BLK_CSIS_UID_SSMT_D1_IPCLKPORT_ACLK       0x20f4
#define CLK_CON_GAT_GOUT_BLK_CSIS_UID_SSMT_D1_IPCLKPORT_PCLK       0x20f8
#define CLK_CON_GAT_GOUT_BLK_CSIS_UID_SYSMMU_D0_CSIS_IPCLKPORT_CLK_S1 0x20fc
#define CLK_CON_GAT_GOUT_BLK_CSIS_UID_SYSMMU_D0_CSIS_IPCLKPORT_CLK_S2 0x2100
#define CLK_CON_GAT_GOUT_BLK_CSIS_UID_SYSMMU_D1_CSIS_IPCLKPORT_CLK_S1 0x2104
#define CLK_CON_GAT_GOUT_BLK_CSIS_UID_SYSMMU_D1_CSIS_IPCLKPORT_CLK_S2 0x2108
#define CLK_CON_GAT_GOUT_BLK_CSIS_UID_SYSREG_CSIS_IPCLKPORT_PCLK   0x210c
#define CLK_CON_GAT_GOUT_BLK_CSIS_UID_XIU_D0_CSIS_IPCLKPORT_ACLK   0x2110
#define CLK_CON_GAT_GOUT_BLK_CSIS_UID_XIU_D1_CSIS_IPCLKPORT_ACLK   0x2114
#define CLK_CON_GAT_GOUT_BLK_CSIS_UID_XIU_D2_CSIS_IPCLKPORT_ACLK   0x2118
#define QCH_CON_CSISX8_QCH_C2_CSIS                                 0x3048
#define QCH_CON_CSISX8_QCH_CSIS_DMA                                0x304c
#define QCH_CON_CSISX8_QCH_EBUF                                    0x3050
#define QCH_CON_CSIS_CMU_CSIS_QCH                                  0x3054
#define QCH_CON_D_TZPC_CSIS_QCH                                    0x3058
#define QCH_CON_GPC_CSIS_QCH                                       0x305c
#define QCH_CON_LHM_AST_OTF0_PDPCSIS_QCH                           0x3060
#define QCH_CON_LHM_AST_OTF1_PDPCSIS_QCH                           0x3064
#define QCH_CON_LHM_AST_OTF2_PDPCSIS_QCH                           0x3068
#define QCH_CON_LHM_AST_SOTF0_IPPCSIS_QCH                          0x306c
#define QCH_CON_LHM_AST_SOTF1_IPPCSIS_QCH                          0x3070
#define QCH_CON_LHM_AST_SOTF2_IPPCSIS_QCH                          0x3074
#define QCH_CON_LHM_AST_VO_MCSCCSIS_QCH                            0x3078
#define QCH_CON_LHM_AST_ZOTF0_IPPCSIS_QCH                          0x307c
#define QCH_CON_LHM_AST_ZOTF1_IPPCSIS_QCH                          0x3080
#define QCH_CON_LHM_AST_ZOTF2_IPPCSIS_QCH                          0x3084
#define QCH_CON_LHM_AXI_D_PDPCSIS_QCH                              0x3088
#define QCH_CON_LHM_AXI_P_CSIS_QCH                                 0x308c
#define QCH_CON_LHS_AST_OTF0_CSISPDP_QCH                           0x3090
#define QCH_CON_LHS_AST_OTF1_CSISPDP_QCH                           0x3094
#define QCH_CON_LHS_AST_OTF2_CSISPDP_QCH                           0x3098
#define QCH_CON_LHS_AST_VO_CSISPDP_QCH                             0x309c
#define QCH_CON_LHS_AXI_D0_CSIS_QCH                                0x30a0
#define QCH_CON_LHS_AXI_D1_CSIS_QCH                                0x30a4
#define QCH_CON_MIPI_PHY_LINK_WRAP_QCH_CSIS0                       0x30a8
#define QCH_CON_MIPI_PHY_LINK_WRAP_QCH_CSIS1                       0x30ac
#define QCH_CON_MIPI_PHY_LINK_WRAP_QCH_CSIS2                       0x30b0
#define QCH_CON_MIPI_PHY_LINK_WRAP_QCH_CSIS3                       0x30b4
#define QCH_CON_MIPI_PHY_LINK_WRAP_QCH_CSIS4                       0x30b8
#define QCH_CON_MIPI_PHY_LINK_WRAP_QCH_CSIS5                       0x30bc
#define QCH_CON_MIPI_PHY_LINK_WRAP_QCH_CSIS6                       0x30c0
#define QCH_CON_MIPI_PHY_LINK_WRAP_QCH_CSIS7                       0x30c4
#define QCH_CON_PPMU_D0_QCH                                        0x30c8
#define QCH_CON_PPMU_D1_QCH                                        0x30cc
#define QCH_CON_QE_CSIS_DMA0_QCH                                   0x30d0
#define QCH_CON_QE_CSIS_DMA1_QCH                                   0x30d4
#define QCH_CON_QE_CSIS_DMA2_QCH                                   0x30d8
#define QCH_CON_QE_CSIS_DMA3_QCH                                   0x30dc
#define QCH_CON_QE_STRP0_QCH                                       0x30e0
#define QCH_CON_QE_STRP1_QCH                                       0x30e4
#define QCH_CON_QE_STRP2_QCH                                       0x30e8
#define QCH_CON_QE_ZSL0_QCH                                        0x30ec
#define QCH_CON_QE_ZSL1_QCH                                        0x30f0
#define QCH_CON_QE_ZSL2_QCH                                        0x30f4
#define QCH_CON_SSMT_D0_QCH                                        0x30f8
#define QCH_CON_SSMT_D1_QCH                                        0x30fc
#define QCH_CON_SYSMMU_D0_CSIS_QCH_S1                              0x3100
#define QCH_CON_SYSMMU_D0_CSIS_QCH_S2                              0x3104
#define QCH_CON_SYSMMU_D1_CSIS_QCH_S1                              0x3108
#define QCH_CON_SYSMMU_D1_CSIS_QCH_S2                              0x310c
#define QCH_CON_SYSREG_CSIS_QCH                                    0x3110

PNAME(mout_csis_bus_user_p)	= { "oscclk", "dout_cmu_csis_bus" };

static const unsigned long csis_clk_regs[] __initconst = {
...
static const struct samsung_mux_clock csis_mux_clks[] __initconst = {
	MUX(CLK_MOUT_CSIS_BUS_USER, "mout_csis_bus_user", mout_csis_bus_user_p,
	    PLL_CON0_MUX_CLKCMU_CSIS_BUS_USER, 4, 1),
};

static const struct samsung_div_clock csis_div_clks[] __initconst = {
	DIV(CLK_DOUT_CSIS_BUSP, "dout_csis_busp", "mout_csis_bus_user",
	    CLK_CON_DIV_DIV_CLK_CSIS_BUSP, 0, 3),
};

static const struct samsung_gate_clock csis_gate_clks[] __initconst = {
	GATE(CLK_GOUT_CSIS_LHS_AXI_D0_CSIS_CLK, "gout_csis_lhs_axi_d0_csis_clk",
	     "mout_csis_bus_user",
	     CLK_CON_GAT_GOUT_BLK_CSIS_UID_LHS_AXI_D0_CSIS_IPCLKPORT_I_CLK, 21,
	     0, 0),
	/* AXI slave port into the block */
	GATE(CLK_GOUT_CSIS_LHM_AXI_P_CSIS_CLK, "gout_csis_lhm_axi_p_csis_clk",
	     "dout_csis_busp",
	     CLK_CON_GAT_GOUT_BLK_CSIS_UID_LHM_AXI_P_CSIS_IPCLKPORT_I_CLK, 21,
	     CLK_IGNORE_UNUSED, 0),
	GATE(CLK_GOUT_CSIS_SYSREG_CSIS_PCLK, "gout_csis_sysreg_csis_pclk",
	     "dout_csis_busp",
	     CLK_CON_GAT_GOUT_BLK_CSIS_UID_SYSREG_CSIS_IPCLKPORT_PCLK, 21, 0, 0),
	GATE(CLK_GOUT_CSIS_CLK_CSIS_BUSD_CLK, "gout_csis_clk_csis_busd_clk",
	     "mout_csis_bus_user",
	     CLK_CON_GAT_GOUT_BLK_CSIS_UID_RSTNSYNC_CLK_CSIS_BUSD_IPCLKPORT_CLK,
	     21, 0, 0),
	GATE(CLK_GOUT_CSIS_CLK_CSIS_BUSP_CLK, "gout_csis_clk_csis_busp_clk",
	     "dout_csis_busp",
	     CLK_CON_GAT_GOUT_BLK_CSIS_UID_RSTNSYNC_CLK_CSIS_BUSP_IPCLKPORT_CLK,
	     21, 0, 0),
	/* the CMU's own APB clock -- gating it strands the block */
	GATE(CLK_GOUT_CSIS_CMU_CSIS_PCLK, "gout_csis_cmu_csis_pclk",
	     "dout_csis_busp",
	     CLK_CON_GAT_CLK_BLK_CSIS_UID_CSIS_CMU_CSIS_IPCLKPORT_PCLK, 21,
	     CLK_IGNORE_UNUSED, 0),
	GATE(CLK_GOUT_CSIS_LHM_AST_ZOTF2_IPPCSIS_CLK,
	     "gout_csis_lhm_ast_zotf2_ippcsis_clk", "mout_csis_bus_user",
	     CLK_CON_GAT_GOUT_BLK_CSIS_UID_LHM_AST_ZOTF2_IPPCSIS_IPCLKPORT_I_CLK,
	     21, 0, 0),
	GATE(CLK_GOUT_CSIS_MIPI_PHY_LINK_WRAP_ACLK_CSIS1,
	     "gout_csis_mipi_phy_link_wrap_aclk_csis1", "mout_csis_bus_user",
	     CLK_CON_GAT_GOUT_BLK_CSIS_UID_MIPI_PHY_LINK_WRAP_IPCLKPORT_ACLK_CSIS1,
	     21, 0, 0),
	GATE(CLK_GOUT_CSIS_MIPI_PHY_LINK_WRAP_ACLK_CSIS2,
	     "gout_csis_mipi_phy_link_wrap_aclk_csis2", "mout_csis_bus_user",
	     CLK_CON_GAT_GOUT_BLK_CSIS_UID_MIPI_PHY_LINK_WRAP_IPCLKPORT_ACLK_CSIS2,
	     21, 0, 0),
	GATE(CLK_GOUT_CSIS_MIPI_PHY_LINK_WRAP_ACLK_CSIS3,
	     "gout_csis_mipi_phy_link_wrap_aclk_csis3", "mout_csis_bus_user",
	     CLK_CON_GAT_GOUT_BLK_CSIS_UID_MIPI_PHY_LINK_WRAP_IPCLKPORT_ACLK_CSIS3,
	     21, 0, 0),
	GATE(CLK_GOUT_CSIS_D_TZPC_CSIS_PCLK, "gout_csis_d_tzpc_csis_pclk",
	     "dout_csis_busp",
	     CLK_CON_GAT_GOUT_BLK_CSIS_UID_D_TZPC_CSIS_IPCLKPORT_PCLK, 21, 0, 0),
	GATE(CLK_GOUT_CSIS_MIPI_PHY_LINK_WRAP_ACLK_CSIS5,
	     "gout_csis_mipi_phy_link_wrap_aclk_csis5", "mout_csis_bus_user",
	     CLK_CON_GAT_GOUT_BLK_CSIS_UID_MIPI_PHY_LINK_WRAP_IPCLKPORT_ACLK_CSIS5,
	     21, 0, 0),
	GATE(CLK_GOUT_CSIS_LHM_AST_ZOTF1_IPPCSIS_CLK,
	     "gout_csis_lhm_ast_zotf1_ippcsis_clk", "mout_csis_bus_user",
	     CLK_CON_GAT_GOUT_BLK_CSIS_UID_LHM_AST_ZOTF1_IPPCSIS_IPCLKPORT_I_CLK,
	     21, 0, 0),
	GATE(CLK_GOUT_CSIS_PPMU_D0_PCLK, "gout_csis_ppmu_d0_pclk",
	     "dout_csis_busp",
	     CLK_CON_GAT_GOUT_BLK_CSIS_UID_PPMU_D0_IPCLKPORT_PCLK, 21, 0, 0),
	GATE(CLK_GOUT_CSIS_MIPI_PHY_LINK_WRAP_ACLK_CSIS4,
	     "gout_csis_mipi_phy_link_wrap_aclk_csis4", "mout_csis_bus_user",
	     CLK_CON_GAT_GOUT_BLK_CSIS_UID_MIPI_PHY_LINK_WRAP_IPCLKPORT_ACLK_CSIS4,
	     21, 0, 0),
	GATE(CLK_GOUT_CSIS_LHM_AST_ZOTF0_IPPCSIS_CLK,
	     "gout_csis_lhm_ast_zotf0_ippcsis_clk", "mout_csis_bus_user",
	     CLK_CON_GAT_GOUT_BLK_CSIS_UID_LHM_AST_ZOTF0_IPPCSIS_IPCLKPORT_I_CLK,
	     21, 0, 0),
	GATE(CLK_GOUT_CSIS_LHM_AST_SOTF0_IPPCSIS_CLK,
	     "gout_csis_lhm_ast_sotf0_ippcsis_clk", "mout_csis_bus_user",
	     CLK_CON_GAT_GOUT_BLK_CSIS_UID_LHM_AST_SOTF0_IPPCSIS_IPCLKPORT_I_CLK,
	     21, 0, 0),
	GATE(CLK_GOUT_CSIS_LHM_AST_SOTF1_IPPCSIS_CLK,
	     "gout_csis_lhm_ast_sotf1_ippcsis_clk", "mout_csis_bus_user",
	     CLK_CON_GAT_GOUT_BLK_CSIS_UID_LHM_AST_SOTF1_IPPCSIS_IPCLKPORT_I_CLK,
	     21, 0, 0),
	GATE(CLK_GOUT_CSIS_LHM_AST_SOTF2_IPPCSIS_CLK,
	     "gout_csis_lhm_ast_sotf2_ippcsis_clk", "mout_csis_bus_user",
	     CLK_CON_GAT_GOUT_BLK_CSIS_UID_LHM_AST_SOTF2_IPPCSIS_IPCLKPORT_I_CLK,
	     21, 0, 0),
	GATE(CLK_GOUT_CSIS_LHS_AST_OTF0_CSISPDP_CLK,
	     "gout_csis_lhs_ast_otf0_csispdp_clk", "mout_csis_bus_user",
	     CLK_CON_GAT_GOUT_BLK_CSIS_UID_LHS_AST_OTF0_CSISPDP_IPCLKPORT_I_CLK,
	     21, 0, 0),
	GATE(CLK_GOUT_CSIS_LHS_AST_OTF1_CSISPDP_CLK,
	     "gout_csis_lhs_ast_otf1_csispdp_clk", "mout_csis_bus_user",
	     CLK_CON_GAT_GOUT_BLK_CSIS_UID_LHS_AST_OTF1_CSISPDP_IPCLKPORT_I_CLK,
	     21, 0, 0),
	GATE(CLK_GOUT_CSIS_LHS_AST_OTF2_CSISPDP_CLK,
	     "gout_csis_lhs_ast_otf2_csispdp_clk", "mout_csis_bus_user",
	     CLK_CON_GAT_GOUT_BLK_CSIS_UID_LHS_AST_OTF2_CSISPDP_IPCLKPORT_I_CLK,
	     21, 0, 0),
	GATE(CLK_GOUT_CSIS_GPC_CSIS_PCLK, "gout_csis_gpc_csis_pclk",
	     "dout_csis_busp",
	     CLK_CON_GAT_GOUT_BLK_CSIS_UID_GPC_CSIS_IPCLKPORT_PCLK, 21, 0, 0),
	GATE(CLK_GOUT_CSIS_AD_APB_CSIS0_PCLKM, "gout_csis_ad_apb_csis0_pclkm",
	     "mout_csis_bus_user",
	     CLK_CON_GAT_GOUT_BLK_CSIS_UID_AD_APB_CSIS0_IPCLKPORT_PCLKM, 21, 0,
	     0),
	GATE(CLK_GOUT_CSIS_PPMU_D0_ACLK, "gout_csis_ppmu_d0_aclk",
	     "mout_csis_bus_user",
	     CLK_CON_GAT_GOUT_BLK_CSIS_UID_PPMU_D0_IPCLKPORT_ACLK, 21, 0, 0),
	GATE(CLK_GOUT_CSIS_PPMU_D1_ACLK, "gout_csis_ppmu_d1_aclk",
	     "mout_csis_bus_user",
	     CLK_CON_GAT_GOUT_BLK_CSIS_UID_PPMU_D1_IPCLKPORT_ACLK, 21, 0, 0),
	GATE(CLK_GOUT_CSIS_PPMU_D1_PCLK, "gout_csis_ppmu_d1_pclk",
	     "dout_csis_busp",
	     CLK_CON_GAT_GOUT_BLK_CSIS_UID_PPMU_D1_IPCLKPORT_PCLK, 21, 0, 0),
	/* IOMMU */
	GATE(CLK_GOUT_CSIS_SYSMMU_D0_CSIS_CLK_S2,
	     "gout_csis_sysmmu_d0_csis_clk_s2", "mout_csis_bus_user",
	     CLK_CON_GAT_GOUT_BLK_CSIS_UID_SYSMMU_D0_CSIS_IPCLKPORT_CLK_S2, 21,
	     CLK_IGNORE_UNUSED, 0),
	/* IOMMU */
	GATE(CLK_GOUT_CSIS_SYSMMU_D1_CSIS_CLK_S1,
	     "gout_csis_sysmmu_d1_csis_clk_s1", "mout_csis_bus_user",
	     CLK_CON_GAT_GOUT_BLK_CSIS_UID_SYSMMU_D1_CSIS_IPCLKPORT_CLK_S1, 21,
	     CLK_IGNORE_UNUSED, 0),
	GATE(CLK_GOUT_CSIS_SSMT_D1_ACLK, "gout_csis_ssmt_d1_aclk",
	     "mout_csis_bus_user",
	     CLK_CON_GAT_GOUT_BLK_CSIS_UID_SSMT_D1_IPCLKPORT_ACLK, 21, 0, 0),
	GATE(CLK_GOUT_CSIS_SSMT_D1_PCLK, "gout_csis_ssmt_d1_pclk",
	     "dout_csis_busp",
	     CLK_CON_GAT_GOUT_BLK_CSIS_UID_SSMT_D1_IPCLKPORT_PCLK, 21, 0, 0),
	GATE(CLK_GOUT_CSIS_SSMT_D0_ACLK, "gout_csis_ssmt_d0_aclk",
	     "mout_csis_bus_user",
	     CLK_CON_GAT_GOUT_BLK_CSIS_UID_SSMT_D0_IPCLKPORT_ACLK, 21, 0, 0),
	GATE(CLK_GOUT_CSIS_SSMT_D0_PCLK, "gout_csis_ssmt_d0_pclk",
	     "dout_csis_busp",
	     CLK_CON_GAT_GOUT_BLK_CSIS_UID_SSMT_D0_IPCLKPORT_PCLK, 21, 0, 0),
	GATE(CLK_GOUT_CSIS_QE_ZSL1_ACLK, "gout_csis_qe_zsl1_aclk",
	     "mout_csis_bus_user",
	     CLK_CON_GAT_GOUT_BLK_CSIS_UID_QE_ZSL1_IPCLKPORT_ACLK, 21, 0, 0),
	GATE(CLK_GOUT_CSIS_QE_ZSL1_PCLK, "gout_csis_qe_zsl1_pclk",
	     "dout_csis_busp",
	     CLK_CON_GAT_GOUT_BLK_CSIS_UID_QE_ZSL1_IPCLKPORT_PCLK, 21, 0, 0),
	GATE(CLK_GOUT_CSIS_QE_ZSL2_ACLK, "gout_csis_qe_zsl2_aclk",
	     "mout_csis_bus_user",
	     CLK_CON_GAT_GOUT_BLK_CSIS_UID_QE_ZSL2_IPCLKPORT_ACLK, 21, 0, 0),
	GATE(CLK_GOUT_CSIS_QE_ZSL2_PCLK, "gout_csis_qe_zsl2_pclk",
	     "dout_csis_busp",
	     CLK_CON_GAT_GOUT_BLK_CSIS_UID_QE_ZSL2_IPCLKPORT_PCLK, 21, 0, 0),
	GATE(CLK_GOUT_CSIS_QE_ZSL0_ACLK, "gout_csis_qe_zsl0_aclk",
	     "mout_csis_bus_user",
	     CLK_CON_GAT_GOUT_BLK_CSIS_UID_QE_ZSL0_IPCLKPORT_ACLK, 21, 0, 0),
	GATE(CLK_GOUT_CSIS_QE_ZSL0_PCLK, "gout_csis_qe_zsl0_pclk",
	     "dout_csis_busp",
	     CLK_CON_GAT_GOUT_BLK_CSIS_UID_QE_ZSL0_IPCLKPORT_PCLK, 21, 0, 0),
	GATE(CLK_GOUT_CSIS_QE_STRP0_ACLK, "gout_csis_qe_strp0_aclk",
	     "mout_csis_bus_user",
	     CLK_CON_GAT_GOUT_BLK_CSIS_UID_QE_STRP0_IPCLKPORT_ACLK, 21, 0, 0),
	GATE(CLK_GOUT_CSIS_QE_STRP0_PCLK, "gout_csis_qe_strp0_pclk",
	     "dout_csis_busp",
	     CLK_CON_GAT_GOUT_BLK_CSIS_UID_QE_STRP0_IPCLKPORT_PCLK, 21, 0, 0),
	/* bus crossbar */
	GATE(CLK_GOUT_CSIS_XIU_D0_CSIS_ACLK, "gout_csis_xiu_d0_csis_aclk",
	     "mout_csis_bus_user",
	     CLK_CON_GAT_GOUT_BLK_CSIS_UID_XIU_D0_CSIS_IPCLKPORT_ACLK, 21,
	     CLK_IGNORE_UNUSED, 0),
	/* bus crossbar */
	GATE(CLK_GOUT_CSIS_XIU_D1_CSIS_ACLK, "gout_csis_xiu_d1_csis_aclk",
	     "mout_csis_bus_user",
	     CLK_CON_GAT_GOUT_BLK_CSIS_UID_XIU_D1_CSIS_IPCLKPORT_ACLK, 21,
	     CLK_IGNORE_UNUSED, 0),
	GATE(CLK_GOUT_CSIS_MIPI_PHY_LINK_WRAP_ACLK_CSIS6,
	     "gout_csis_mipi_phy_link_wrap_aclk_csis6", "mout_csis_bus_user",
	     CLK_CON_GAT_GOUT_BLK_CSIS_UID_MIPI_PHY_LINK_WRAP_IPCLKPORT_ACLK_CSIS6,
	     21, 0, 0),
	GATE(CLK_GOUT_CSIS_MIPI_PHY_LINK_WRAP_ACLK_CSIS7,
	     "gout_csis_mipi_phy_link_wrap_aclk_csis7", "mout_csis_bus_user",
	     CLK_CON_GAT_GOUT_BLK_CSIS_UID_MIPI_PHY_LINK_WRAP_IPCLKPORT_ACLK_CSIS7,
	     21, 0, 0),
	GATE(CLK_GOUT_CSIS_LHM_AST_VO_MCSCCSIS_CLK,
	     "gout_csis_lhm_ast_vo_mcsccsis_clk", "mout_csis_bus_user",
	     CLK_CON_GAT_GOUT_BLK_CSIS_UID_LHM_AST_VO_MCSCCSIS_IPCLKPORT_I_CLK,
	     21, 0, 0),
	GATE(CLK_GOUT_CSIS_LHS_AXI_D1_CSIS_CLK, "gout_csis_lhs_axi_d1_csis_clk",
	     "mout_csis_bus_user",
	     CLK_CON_GAT_GOUT_BLK_CSIS_UID_LHS_AXI_D1_CSIS_IPCLKPORT_I_CLK, 21,
	     0, 0),
	/* IOMMU */
	GATE(CLK_GOUT_CSIS_SYSMMU_D0_CSIS_CLK_S1,
	     "gout_csis_sysmmu_d0_csis_clk_s1", "mout_csis_bus_user",
	     CLK_CON_GAT_GOUT_BLK_CSIS_UID_SYSMMU_D0_CSIS_IPCLKPORT_CLK_S1, 21,
	     CLK_IGNORE_UNUSED, 0),
	/* IOMMU */
	GATE(CLK_GOUT_CSIS_SYSMMU_D1_CSIS_CLK_S2,
	     "gout_csis_sysmmu_d1_csis_clk_s2", "mout_csis_bus_user",
	     CLK_CON_GAT_GOUT_BLK_CSIS_UID_SYSMMU_D1_CSIS_IPCLKPORT_CLK_S2, 21,
	     CLK_IGNORE_UNUSED, 0),
	GATE(CLK_GOUT_CSIS_LHM_AST_OTF0_PDPCSIS_CLK,
	     "gout_csis_lhm_ast_otf0_pdpcsis_clk", "mout_csis_bus_user",
	     CLK_CON_GAT_GOUT_BLK_CSIS_UID_LHM_AST_OTF0_PDPCSIS_IPCLKPORT_I_CLK,
	     21, 0, 0),
	GATE(CLK_GOUT_CSIS_LHM_AST_OTF1_PDPCSIS_CLK,
	     "gout_csis_lhm_ast_otf1_pdpcsis_clk", "mout_csis_bus_user",
	     CLK_CON_GAT_GOUT_BLK_CSIS_UID_LHM_AST_OTF1_PDPCSIS_IPCLKPORT_I_CLK,
	     21, 0, 0),
	GATE(CLK_GOUT_CSIS_LHM_AST_OTF2_PDPCSIS_CLK,
	     "gout_csis_lhm_ast_otf2_pdpcsis_clk", "mout_csis_bus_user",
	     CLK_CON_GAT_GOUT_BLK_CSIS_UID_LHM_AST_OTF2_PDPCSIS_IPCLKPORT_I_CLK,
	     21, 0, 0),
	GATE(CLK_GOUT_CSIS_LHS_AST_VO_CSISPDP_CLK,
	     "gout_csis_lhs_ast_vo_csispdp_clk", "mout_csis_bus_user",
	     CLK_CON_GAT_GOUT_BLK_CSIS_UID_LHS_AST_VO_CSISPDP_IPCLKPORT_I_CLK,
	     21, 0, 0),
	GATE(CLK_GOUT_CSIS_LHM_AXI_D_PDPCSIS_CLK,
	     "gout_csis_lhm_axi_d_pdpcsis_clk", "mout_csis_bus_user",
	     CLK_CON_GAT_GOUT_BLK_CSIS_UID_LHM_AXI_D_PDPCSIS_IPCLKPORT_I_CLK,
	     21, 0, 0),
	GATE(CLK_GOUT_CSIS_QE_STRP2_ACLK, "gout_csis_qe_strp2_aclk",
	     "mout_csis_bus_user",
	     CLK_CON_GAT_GOUT_BLK_CSIS_UID_QE_STRP2_IPCLKPORT_ACLK, 21, 0, 0),
	GATE(CLK_GOUT_CSIS_QE_STRP2_PCLK, "gout_csis_qe_strp2_pclk",
	     "dout_csis_busp",
	     CLK_CON_GAT_GOUT_BLK_CSIS_UID_QE_STRP2_IPCLKPORT_PCLK, 21, 0, 0),
	GATE(CLK_GOUT_CSIS_QE_STRP1_ACLK, "gout_csis_qe_strp1_aclk",
	     "mout_csis_bus_user",
	     CLK_CON_GAT_GOUT_BLK_CSIS_UID_QE_STRP1_IPCLKPORT_ACLK, 21, 0, 0),
	GATE(CLK_GOUT_CSIS_QE_STRP1_PCLK, "gout_csis_qe_strp1_pclk",
	     "dout_csis_busp",
	     CLK_CON_GAT_GOUT_BLK_CSIS_UID_QE_STRP1_IPCLKPORT_PCLK, 21, 0, 0),
	/* bus crossbar */
	GATE(CLK_GOUT_CSIS_XIU_D2_CSIS_ACLK, "gout_csis_xiu_d2_csis_aclk",
	     "mout_csis_bus_user",
	     CLK_CON_GAT_GOUT_BLK_CSIS_UID_XIU_D2_CSIS_IPCLKPORT_ACLK, 21,
	     CLK_IGNORE_UNUSED, 0),
	GATE(CLK_GOUT_CSIS_MIPI_PHY_LINK_WRAP_ACLK_CSIS0,
	     "gout_csis_mipi_phy_link_wrap_aclk_csis0", "mout_csis_bus_user",
	     CLK_CON_GAT_GOUT_BLK_CSIS_UID_MIPI_PHY_LINK_WRAP_IPCLKPORT_ACLK_CSIS0,
	     21, 0, 0),
	GATE(CLK_GOUT_CSIS_CSISX8_ACLK_EBUF, "gout_csis_csisx8_aclk_ebuf",
	     "mout_csis_bus_user",
	     CLK_CON_GAT_GOUT_BLK_CSIS_UID_CSISX8_IPCLKPORT_ACLK_EBUF, 21, 0, 0),
	GATE(CLK_GOUT_CSIS_CSISX8_ACLK_CSIS_DMA,
	     "gout_csis_csisx8_aclk_csis_dma", "mout_csis_bus_user",
	     CLK_CON_GAT_GOUT_BLK_CSIS_UID_CSISX8_IPCLKPORT_ACLK_CSIS_DMA, 21,
	     0, 0),
	GATE(CLK_GOUT_CSIS_CSISX8_ACLK_C2_CSIS, "gout_csis_csisx8_aclk_c2_csis",
	     "mout_csis_bus_user",
	     CLK_CON_GAT_GOUT_BLK_CSIS_UID_CSISX8_IPCLKPORT_ACLK_C2_CSIS, 21, 0,
	     0),
	GATE(CLK_GOUT_CSIS_QE_CSIS_DMA0_ACLK, "gout_csis_qe_csis_dma0_aclk",
	     "mout_csis_bus_user",
	     CLK_CON_GAT_GOUT_BLK_CSIS_UID_QE_CSIS_DMA0_IPCLKPORT_ACLK, 21, 0,
	     0),
	GATE(CLK_GOUT_CSIS_QE_CSIS_DMA0_PCLK, "gout_csis_qe_csis_dma0_pclk",
	     "dout_csis_busp",
	     CLK_CON_GAT_GOUT_BLK_CSIS_UID_QE_CSIS_DMA0_IPCLKPORT_PCLK, 21, 0,
	     0),
	GATE(CLK_GOUT_CSIS_QE_CSIS_DMA1_ACLK, "gout_csis_qe_csis_dma1_aclk",
	     "mout_csis_bus_user",
	     CLK_CON_GAT_GOUT_BLK_CSIS_UID_QE_CSIS_DMA1_IPCLKPORT_ACLK, 21, 0,
	     0),
	GATE(CLK_GOUT_CSIS_QE_CSIS_DMA1_PCLK, "gout_csis_qe_csis_dma1_pclk",
	     "dout_csis_busp",
	     CLK_CON_GAT_GOUT_BLK_CSIS_UID_QE_CSIS_DMA1_IPCLKPORT_PCLK, 21, 0,
	     0),
	GATE(CLK_GOUT_CSIS_QE_CSIS_DMA2_ACLK, "gout_csis_qe_csis_dma2_aclk",
	     "mout_csis_bus_user",
	     CLK_CON_GAT_GOUT_BLK_CSIS_UID_QE_CSIS_DMA2_IPCLKPORT_ACLK, 21, 0,
	     0),
	GATE(CLK_GOUT_CSIS_QE_CSIS_DMA2_PCLK, "gout_csis_qe_csis_dma2_pclk",
	     "dout_csis_busp",
	     CLK_CON_GAT_GOUT_BLK_CSIS_UID_QE_CSIS_DMA2_IPCLKPORT_PCLK, 21, 0,
	     0),
	GATE(CLK_GOUT_CSIS_QE_CSIS_DMA3_ACLK, "gout_csis_qe_csis_dma3_aclk",
	     "mout_csis_bus_user",
	     CLK_CON_GAT_GOUT_BLK_CSIS_UID_QE_CSIS_DMA3_IPCLKPORT_ACLK, 21, 0,
	     0),
	GATE(CLK_GOUT_CSIS_QE_CSIS_DMA3_PCLK, "gout_csis_qe_csis_dma3_pclk",
	     "dout_csis_busp",
	     CLK_CON_GAT_GOUT_BLK_CSIS_UID_QE_CSIS_DMA3_IPCLKPORT_PCLK, 21, 0,
	     0),
};

static const struct samsung_cmu_info csis_cmu_info __initconst = {
	.mux_clks		= csis_mux_clks,
	.nr_mux_clks		= ARRAY_SIZE(csis_mux_clks),
	.div_clks		= csis_div_clks,
	.nr_div_clks		= ARRAY_SIZE(csis_div_clks),
	.gate_clks		= csis_gate_clks,
	.nr_gate_clks		= ARRAY_SIZE(csis_gate_clks),
	.nr_clk_ids		= CLKS_NR_CSIS,
	.clk_regs		= csis_clk_regs,
	.nr_clk_regs		= ARRAY_SIZE(csis_clk_regs),
	.sysreg_clk_regs	= dcrg_memclk_sysreg,
	.nr_sysreg_clk_regs	= ARRAY_SIZE(dcrg_memclk_sysreg),
	.clk_name		= "bus",
	.auto_clock_gate	= true,
	.gate_dbg_offset	= GS101_GATE_DBG_OFFSET,
	.option_offset		= CSIS_CMU_CSIS_CONTROLLER_OPTION,
	.drcg_offset		= GS101_DRCG_EN_OFFSET,
	.memclk_offset		= GS101_MEMCLK_OFFSET,
};
...
static const struct of_device_id gs101_cmu_of_match[] = {
	{
		...
		.compatible = "google,gs101-cmu-csis",
		.data = &csis_cmu_info,
	}, {
